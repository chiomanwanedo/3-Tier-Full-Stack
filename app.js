...
// ✅ Fixed: use proper options for Mongoose 5.x
...
// Helmet with CSP (Mapbox/Cloudinary/Unsplash allowed)
...
app.get('/health', (req, res) => {
  ...
  return res.status(200).json({ status: 'ok', db: dbState === 1 ? 'connected' : dbState });
});
